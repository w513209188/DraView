package com.wangbo.www.draviewlib.view;
...
import com.wangbo.www.draviewlib.R;
...
public class CustomDrawView extends RelativeLayout {
    ...
    private void initView(Context context,AttributeSet att){
        ...
        int bg=typedArray.getResourceId(R.styleable.CustomDrawView_draw_img,R.drawable.ic_launcher);
